...
func InitializeServer(ctx context.Context) (*note.Server, func(), error) {
	...
	trashWorkspaceItemsHandler := app.NewTrashWorkspaceItemsHandler(authorization, pgNote, folder)
	...
	checkWorkspaceExistsHandler := app.NewCheckWorkspaceSlugExistsHandler(readModel)
