...
func (h *CheckWorkspaceSlugExistsHandler) Handle(ctx context.Context, q *CheckWorkspaceSlugExists) (*CheckWorkspaceSlugExistsResult, errs.Error) {
	return h.readModel.CheckWorkspaceSlugExists(ctx, q)
}
