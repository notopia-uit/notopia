...
func (h *StrictHandler) CreateNote(
	...
	err = h.App.Cmds.CreateNote.Handle(ctx, cmd)
	if err != nil {
		return nil, err
	}
...
func (h *StrictHandler) PermanentlyDeleteNote(
	...
	err := h.App.Cmds.DeleteNote.Handle(ctx, cmd)
	if err != nil {
		return nil, err
	}
...
func (h *StrictHandler) GetNote(
	...
	result, err := h.App.Queries.GetNote.Handle(ctx, query)
	if err != nil {
		return nil, err
	}
...
func (h *StrictHandler) GetNoteGraph(
	...
	result, err := h.App.Queries.GetNoteGraph.Handle(ctx, query)
	if err != nil {
		return nil, err
	}
...
func (h *StrictHandler) GetNoteLinks(
	...
	result, err := h.App.Queries.GetNoteLinks.Handle(ctx, query)
	if err != nil {
		return nil, err
	}
...
func (h *StrictHandler) RenameNote(
	...
	err := h.App.Cmds.RenameNote.Handle(ctx, cmd)
	if err != nil {
		return nil, err
	}
