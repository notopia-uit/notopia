...
type GetUserWorkspaceItemPermissionsCmd commonhandler.Query[GetUserWorkspaceItemPermissions, WorkspaceItemPermissions]

var _ GetUserWorkspaceItemPermissionsCmd = (*GetUserWorkspaceItemPermissionsHandler)(nil)
