 ...
 * Get graph
 */
export const getGraph = <ThrowOnError extends boolean = false>(options?: Options<GetGraphData, ThrowOnError>) => (options?.client ?? client).get<GetGraphResponses, GetGraphErrors, ThrowOnError>({
