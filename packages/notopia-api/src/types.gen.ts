...
export type ClientOptions = {
    baseUrl: `${string}://${string}` | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | 'http://api.notopia.localhost' | (string & {});
};
...
export type WorkspaceIdPath = PropertiesId;
