 ...
 * Empty trash
 */
export const useEmptyTrashMutation = (mutationOptions?: Partial<Omit<UseMutationOptions<EmptyTrashResponse, EmptyTrashError, Options<EmptyTrashData>>, 'mutationFn'>>) => useMutation({ ...emptyTrashMutation(), ...mutationOptions });
