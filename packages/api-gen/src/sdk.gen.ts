...
import { zChangeWorkspaceSlugBody, zChangeWorkspaceSlugPath, zChangeWorkspaceSlugResponse, zCheckWorkspaceSlugExistsPath, zCommitDocumentPath, zCommitDocumentResponse, zCreateFolderBody, zCreateFolderResponse, zCreateNoteBody, zCreateNoteResponse, zCreateWorkspaceBody, zCreateWorkspaceResponse, zDeleteRevisionPath, zDeleteRevisionResponse, zDeleteWorkspacePath, zDeleteWorkspaceResponse, zGetDocumentAttachmentUploadUrlPath, zGetDocumentAttachmentUploadUrlResponse, zGetMyWorkspacesResponse, zGetNoteGraphPath, zGetNoteGraphQuery, zGetNoteGraphResponse, zGetNoteLinksPath, zGetNoteLinksQuery, zGetNoteLinksResponse, zGetNotePath, zGetNoteQuery, zGetNoteResponse, zGetRevisionsQuery, zGetRevisionsResponse, zGetRevisionWithContentPath, zGetRevisionWithContentResponse, zGetWorkspaceEventsPath, zGetWorkspaceEventsResponse, zGetWorkspaceGraphPath, zGetWorkspaceGraphQuery, zGetWorkspaceGraphResponse, zGetWorkspaceMembersPath, zGetWorkspaceMembersResponse, zGetWorkspacePath, zGetWorkspaceResponse, zGetWorkspaceSearchTokenPath, zGetWorkspaceSearchTokenResponse, zGetWorkspaceTreePath, zGetWorkspaceTreeQuery, zGetWorkspaceTreeResponse, zLeaveWorkspacePath, zLeaveWorkspaceResponse, zMoveWorkspaceItemsBody, zMoveWorkspaceItemsPath, zMoveWorkspaceItemsResponse, zPermanentlyDeleteFolderPath, zPermanentlyDeleteFolderResponse, zPermanentlyDeleteNotePath, zPermanentlyDeleteNoteResponse, zPermanentlyDeleteWorkspaceItemsBody, zPermanentlyDeleteWorkspaceItemsPath, zPermanentlyDeleteWorkspaceItemsResponse, zPublishNotePath, zPublishNoteResponse, zPublishWorkspacePath, zPublishWorkspaceResponse, zRenameFolderBody, zRenameFolderPath, zRenameFolderResponse, zRenameNoteBody, zRenameNotePath, zRenameNoteResponse, zRenameRevisionBody, zRenameRevisionPath, zRenameRevisionResponse, zRenameWorkspaceBody, zRenameWorkspacePath, zRenameWorkspaceResponse, zRestoreTrashedWorkspaceItemsBody, zRestoreTrashedWorkspaceItemsPath, zRestoreTrashedWorkspaceItemsResponse, zShowTrashPath, zShowTrashResponse, zTrashWorkspaceItemsBody, zTrashWorkspaceItemsPath, zTrashWorkspaceItemsResponse, zUnpublishNotePath, zUnpublishNoteResponse, zUnpublishWorkspacePath, zUnpublishWorkspaceResponse, zUpdateWorkspaceMembersBody, zUpdateWorkspaceMembersPath, zUpdateWorkspaceMembersResponse } from './zod.gen';
...
export const changeWorkspaceSlug = <ThrowOnError extends boolean = false>(options: Options<ChangeWorkspaceSlugData, ThrowOnError>) => (options.client ?? client).post<ChangeWorkspaceSlugResponses, ChangeWorkspaceSlugErrors, ThrowOnError>({
    requestValidator: async (data) => await z.object({
        body: zChangeWorkspaceSlugBody,
        path: zChangeWorkspaceSlugPath,
        query: z.never().optional()
    }).parseAsync(data),
...
export const leaveWorkspace = <ThrowOnError extends boolean = false>(options: Options<LeaveWorkspaceData, ThrowOnError>) => (options.client ?? client).post<LeaveWorkspaceResponses, LeaveWorkspaceErrors, ThrowOnError>({
    requestValidator: async (data) => await z.object({
        body: z.never().optional(),
        path: zLeaveWorkspacePath,
        query: z.never().optional()
    }).parseAsync(data),
    responseValidator: async (data) => await zLeaveWorkspaceResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
...
export const getWorkspaceSearchToken = <ThrowOnError extends boolean = false>(options: Options<GetWorkspaceSearchTokenData, ThrowOnError>) => (options.client ?? client).get<GetWorkspaceSearchTokenResponses, GetWorkspaceSearchTokenErrors, ThrowOnError>({
    requestValidator: async (data) => await z.object({
        body: z.never().optional(),
        path: zGetWorkspaceSearchTokenPath,
        query: z.never().optional()
    }).parseAsync(data),
