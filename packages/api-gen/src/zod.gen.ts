...
export const zNoteWorkspacePropertiesId = z.uuid().readonly();
...
export const zNoteWorkspaceItemsUpdatedEvent = z.object({
    ...
    data: z.object({
        workspaceId: zNoteWorkspacePropertiesId
    })
});
...
export const zNoteNoteIdPath = zNotePropertiesId;
