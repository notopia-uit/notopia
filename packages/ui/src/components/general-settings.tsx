    ...
    <div className="space-y-8">
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <p className="text-sm text-zinc-500">
            This is the name that will be displayed on your workspace dashboard
            and invitations.
          </p>
        </div>
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <p className="text-sm text-zinc-500">
            View and restore recently deleted notes, diagrams, and files from
            this workspace. Items remain in the trash for 30 days before
            permanent deletion.
          </p>
        </div>
        ...
        <Button
          variant="outline"
          className="border-zinc-800 text-zinc-300 hover:bg-zinc-900 hover:text-zinc-50 flex items-center gap-2"
          asChild
        >
